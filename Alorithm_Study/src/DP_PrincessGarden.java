...
즉 3월 1일부터 11월 30일까지 매일 꽃이 한 가지 이상 피어 
있도록 꽃들을 선택할 때, 선택한 꽃들의 최소 개수를 출력하는 프로그램을 작성하시오.
<제약조건>
• 전체 테스트 데이터의 20%는 N≤30
• 전체 테스트 데이터의 50%는 N≤10,000

입력 파일의 첫째 줄에는 꽃들의 총 개수 N(1≤N≤100,000)이 주어진다.
...
2                                  6 3 6 15 
                                    ...
                                    5
*/
public class DP_PrincessGarden {
